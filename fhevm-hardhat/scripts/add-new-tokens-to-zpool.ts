...
async function main() {
  ...
  // ZPool contract address (from deployment)
  ...
  try {
    ...
    const currentTokens = await zpool.getSupportedTokens();
    console.log("Current supported tokens:", currentTokens);
    ...
    console.log("\nUpdated supported tokens in ZPool:");
